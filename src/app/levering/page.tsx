...
const page = () => {
  return (
    <div>
      <h1>Levering</h1>
      <p>Her finner du informasjon om hvordan du kan levere klær til oss.</p>
      <p>Vi tar imot klær på følgende tidspunkt:</p>
      <ul>
        <li>Mandag 12:00-15:00</li>
        <li>Onsdag 12:00-15:00</li>
        <li>Fredag 12:00-15:00</li>
      </ul>
      <p>Vi holder til i Storgata 1, 0155 Oslo.</p>
      <p>Velkommen!</p>
        ...
        <div className="flex flex-col items-center gap-10 px-10 ">
          ...
          <div>
            ...
            <p>
              ...
              klærne, så går vi raskt i gjennom din brukerkonto for å se at alt
              er i orden. Dermed kan vi publisere alle dine klær på vår
              nettside!
            </p>
            <br />
            <p>
          ...
          <div>
            ...
            <p>
              ...
              lagerlokale. Vi har derfor valgt å lagre klærne i vår leilighet.
              Vi har god plass, og klærne dine vil bli lagret trygt og sikkert.
            </p>
          </div>
        </div>
      </>
