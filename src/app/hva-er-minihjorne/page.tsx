...
const page = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        <strong>Minihjørne</strong> er en plattform dedikert til kjøp og salg av
        brukte barneklær. Vi forstår at barn vokser raskt og ofte trenger nye
        klær. Vårt mål er å skape en enkel og trygg markedsplass hvor foreldre
        kan handle barneklær på en mer økonomisk og bærekraftig måte.
      </p>

      <h2 className="mb-2 text-2xl font-semibold">Vår Visjon</h2>
      <p className="mb-4">
        Vi ønsker å fremme gjenbruk av barneklær og redusere tekstilavfall. Ved
        å tilby en plattform hvor foreldre kan kjøpe og selge brukte klær,
        bidrar vi til en grønnere planet og en mer bærekraftig fremtid for våre
        barn.
      </p>
      ...
      <p className="mb-4">
        ...
        vi oppfordrer til åpen kommunikasjon og tilbakemelding mellom kjøpere og
        selgere.
      </p>

      <h2 className="mb-2 text-2xl font-semibold">Bli Med i Vårt Fellesskap</h2>
      <p className="mb-4">
