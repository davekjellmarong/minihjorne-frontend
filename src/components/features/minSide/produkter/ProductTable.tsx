...
import ProductStatusChip from "../../product/ProductStatusChip";
        ...
        <tbody>
          {products?.map((product) => {
            ...
            return (
              <tr
                key={product.id}
                className="cursor-pointer border-b border-indigo-100 active:bg-indigo-100 sm:hover:bg-indigo-100"
                onClick={() => {
